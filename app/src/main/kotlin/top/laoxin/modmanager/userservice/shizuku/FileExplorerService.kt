...
import top.laoxin.modmanager.tools.specialGameTools.SpecialGameToolsManagerEntryPoint
import java.io.File
...
class FileExplorerService : IFileExplorerService.Stub() {
    ...
    private val specialGameToolsManager: SpecialGameToolsManager by lazy {
        EntryPointAccessors.fromApplication(
            App.get(),
            SpecialGameToolsManagerEntryPoint::class.java
        ).specialGameToolsManager()
    }
